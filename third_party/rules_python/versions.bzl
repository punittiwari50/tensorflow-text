...
TOOL_VERSIONS = {
    ...
    "3.14.0": {
        "url": "20260211/cpython-3.14.3+20260211-{platform}-install_only.tar.gz",
        "sha256": {
             "x86_64-unknown-linux-gnu": "a3917eee21b61c9d8bfab22a773d1fe6945683dd40b5d5b263527af2550e3bbf",
        },
        "strip_prefix": "python",
    },
}
